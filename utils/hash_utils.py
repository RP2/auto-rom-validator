...
def validate_file(filepath: Path, sha1_map: Dict[str, Tuple[str, str]], md5_map: Dict[str, Tuple[str, str]], crc32_map: Dict[str, Tuple[str, str]]) -> Optional[Tuple[str, str]]:
