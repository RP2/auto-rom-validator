...
def parse_dat(dat_path: Path) -> Tuple[Dict[str, Tuple[str, str]], Dict[str, Tuple[str, str]], Dict[str, Tuple[str, str]]]:
    ...
    try:
        ...
        for game_section in game_sections:
            ...
            rom_lines = [line.strip() for line in game_content.split('\n') if 'rom (' in line and ')' in line]
...
def parse_custom_dat(dat_path: Path) -> Tuple[Dict[str, Tuple[str, str]], Dict[str, Tuple[str, str]], Dict[str, Tuple[str, str]]]:
